...
const alreadyinStyle = StyleSheet.create({
    ...
    imgbox:{flexDirection:'row',justifyContent:'center',flex:1,alignItems:'center',height:'100%',marginTop:'25%'},
