...
const consertmyticketStyle = StyleSheet.create({
    ...
    headerTitle:{color:COLORS.darkGray,fontSize:13,fontWeight:'700',marginBottom:0,lineHeight:20},
    headercity:{color:COLORS.blue,fontSize:12,marginTop:0,lineHeight:20},
    headerTime:{color:COLORS.darkGray,fontSize:12,marginRight:8,marginTop:0,lineHeight:20},
    slider: {
        height: 251,
        width: '100%',
    ...
    notebox:{marginLeft:16,marginRight:16,marginTop:11},
...
export default consertmyticketStyle;
